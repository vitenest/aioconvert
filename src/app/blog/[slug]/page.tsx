    ...
    <>
      ...
      <main style={{ flex: 1, backgroundColor: 'var(--background)' }}>
        <article style={{ maxWidth: '800px', margin: '4rem auto', padding: '0 2rem' }}>
          <Link href="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--secondary-foreground)', textDecoration: 'none', fontWeight: 500, marginBottom: '2rem', fontSize: '0.95rem' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--foreground)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--secondary-foreground)'}>
